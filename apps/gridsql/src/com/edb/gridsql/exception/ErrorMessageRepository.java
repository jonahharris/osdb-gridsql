...
public class ErrorMessageRepository {
    ...
    public static String AMBIGIOUS_COLUMN_REF = "Ambigious Column Reference ( Column Name )";

    public static int AMBIGIOUS_COLUMN_REF_CODE = -10013;
    ...
    public static String CANNOT_FIND_ALIAS = "CANNOT FIND ALIAS (SQLEXPRESSION) : ";

    public static int CANNOT_FIND_ALIAS_CODE = -10017;
    ...
    public static String ALIAS_NAME_NOT_SET = "The value of alias Name has not been set";

    public static int ALIAS_NAME_NOT_SET_CODE = -30042;
