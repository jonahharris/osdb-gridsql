...
public class TextProcessorThread extends DataProcessorThread<byte[]> {
    ...
    /* (non-Javadoc)
     * @see com.edb.gridsql.engine.loader.DataProcessorThread#getValue(int)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.edb.gridsql.engine.loader.DataProcessorThread#insertGeneratedValues(java.util.Map)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.edb.gridsql.engine.loader.DataProcessorThread#outputRow(com.edb.gridsql.engine.loader.INodeWriter)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.edb.gridsql.engine.loader.DataProcessorThread#parseRow()
     */
    @Override
