...
public class ProducerSender {
            ...
            while (hasRows) {
                ...
                if (aStepDetail.getDestType() == StepDetail.DEST_TYPE_BROADCAST
                    ...
                    if (aStepDetail.getHashColumnPosition() > 0) {
                        ...
                        iPartitionedNode = aStepDetail.getNodeId(aResultSet.getString(sbGroupExpr.toString()));
                    }
    ...
    private class IntermediateSerialGeneratorClient extends SysSerialGenerator {
        ...
        /*
         * @see com.edb.gridsql.MetaData.SysSerialGenerator#update()

         * @throws com.edb.gridsql.exception.XDBGeneratorException
         */
