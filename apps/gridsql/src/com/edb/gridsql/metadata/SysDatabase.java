...
public class SysDatabase {
    ...
    // ------------------------------------------------------------------------
    SysDatabase(int dbID, String dbName) {
        dbid = dbID;
        dbname = dbName;
    ...
    public String getUniqueTableName(String prefix, String suffix,
        ...
        // Reset the counter to zero incase we reach the limit on
        // temp tables , this should help us get away with it.

        // if (counter == Long.MAX_VALUE)
        // {
        // counter = 0;
        // }
        // //amart: I believe that requested table name is for unique table,
        // // so let's make it real temporary
        // String tempTablePrefix = Properties.XDB_SQL_TEMPTABLEPREFIX;
        // prefix = tempTablePrefix + prefix;
        // String tableName = prefix + "_" + client.getSessionID() +"_" +
        // counter++ + suffix;
        // while (isTableExists(tableName))
        // {
        // tableName = prefix + "_" + client.getSessionID() +"_" + counter++ +
        // suffix;
        // }
