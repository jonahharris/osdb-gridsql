...
import com.edb.gridsql.metadata.SysAgent;
...
public class MetaDataUtil implements XDBServerPropNames {
    ...
    public static java.util.Properties getServerProperties() {
        ...
        props.put(DATABASE_PRODUCT_NAME, "GridSQL");
        props.put(DATABASE_VERSION, "GridSQL 0.9");
        ...
        props
                .put(
                        NULLS_SORTED_AT_END,
                        ""
                                + (com.edb.gridsql.common.util.Props.XDB_COMBINED_RESULTSET_SORT_NULLS_STYLE == com.edb.gridsql.common.util.Props.SORT_NULLS_AT_END));
        props
                .put(
                        NULLS_SORTED_AT_START,
                        ""
                                + (com.edb.gridsql.common.util.Props.XDB_COMBINED_RESULTSET_SORT_NULLS_STYLE == com.edb.gridsql.common.util.Props.SORT_NULLS_AT_START));
        props
                .put(
                        NULLS_SORTED_HIGH,
                        ""
                                + (com.edb.gridsql.common.util.Props.XDB_COMBINED_RESULTSET_SORT_NULLS_STYLE == com.edb.gridsql.common.util.Props.SORT_NULLS_HIGH));
        props
                .put(
                        NULLS_SORTED_LOW,
                        ""
                                + (com.edb.gridsql.common.util.Props.XDB_COMBINED_RESULTSET_SORT_NULLS_STYLE == com.edb.gridsql.common.util.Props.SORT_NULLS_LOW));
