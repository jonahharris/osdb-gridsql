...
public class Props {
    ...
    public static final String SERVER_MINOR_VERSION = "0.0.0";
    ...
    public static final String XDB_PROTOCOL_HANDLER_CLASS = Property.get(
            ...
            "com.edb.gridsql.protocol.PgProtocolHandler");
    ...
    public static final String XDB_SQLCOMMAND_CREATEGLOBALTEMPTABLE_START = Property.get(
            "xdb.sqlcommand.createGlobalTempTable.start", "CREATE TABLE");
    ...
    public static final String XDB_LOADER_EDBWRITER_TEMPLATE = Property.get(
    ...
    public static final String XDB_LOADER_EDBWRITER_CSV_TEMPLATE = Property.get(
            "xdb.loader.edbwriter.csv.template",
    ...
    public static final String XDB_DEFAULT_JDBCDRIVER = Property.get(
            "xdb.default.jdbcdriver", "com.edb.Driver");
    ...
    public static final String XDB_DEFAULT_JDBCSTRING = Property.get(
            "xdb.default.jdbcstring", "jdbc:edb://{dbhost}:{dbport}/{database}");
    ...
    public static final int XDB_DEFAULT_THREADS_POOL_IDLE = Property.getInt(
            "xdb.default.threads.pool.idle", 600000);
    ...
    // com.edb.gridsql.Parser.Handler.TypeConstants.java
    ...
    // this corresponds to EnterpriseDB edb_redwood_date property that affects
    // how Date
    // is mapped at the database level, with property being true it maps to
    // TIMESTAMP(0)
    public static final String XDB_EDB_REDWOOD_DATE = Property.get(
