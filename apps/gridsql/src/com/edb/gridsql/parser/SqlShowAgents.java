 ...
 * query executed
 */
public class SqlShowAgents extends ObjectDepthFirst implements IXDBSql,
        IExecutable {
    /**
    ...
    public SqlShowAgents(XDBSessionContext client) {
    }
    ...
    public ExecutionResult execute(Engine engine) throws Exception {
        return ExecutionResult.createResultSetResult(
                ExecutionResult.COMMAND_SHOW, MetaDataUtil.getAgents());
    }
