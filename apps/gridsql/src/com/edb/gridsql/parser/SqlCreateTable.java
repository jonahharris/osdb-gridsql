 ...
 * a) Does not require "("
 *
 * b) Just concatnates the "originaldefiniton" in to the sql statement...
 *
 ...
 */
// -----------------------------------------------------------------
public class SqlCreateTable extends ObjectDepthFirst implements IXDBSql,
        IPreparable {
