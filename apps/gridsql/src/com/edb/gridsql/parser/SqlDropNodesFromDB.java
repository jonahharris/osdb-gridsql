 ...
 *  
 */
public class SqlDropNodesFromDB extends ObjectDepthFirst implements IXDBSql,
        IPreparable {
    /**
     *
     */
    public SqlDropNodesFromDB(XDBSessionContext client) {
    }

    public SqlDropNodesFromDB(String[] nodeList, XDBSessionContext client) {
    }
