...
public class SqlDeleteTable extends SqlModifyTable {
    ...
    protected IConstraintChecker getFRChecker(SysTable targetTable,
        ...
        try {
            ...
            Collection<SysColumn> constraintColumns = frChecker.scanConstraints(getColumnsInvolved());
            if (!constraintColumns.isEmpty()) {
                constrained = true;
                columnsInvolved.addAll(constraintColumns);
            }
            return frChecker;
    ...
    protected SysTable createTempTableMetadata(SysTable targetTable,
        ...
        if (!constrained
                && (whereCondition == null || whereCondition.isSimple())) {
            return null;
        }
