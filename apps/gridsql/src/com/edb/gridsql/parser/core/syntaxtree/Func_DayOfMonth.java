 ...
 */
public class Func_DayOfMonth implements Node {
   public NodeToken f0;
   public NodeToken f1;
   public SQLArgument f2;
   public NodeToken f3;

   public Func_DayOfMonth(NodeToken n0, NodeToken n1, SQLArgument n2, NodeToken n3) {
      f0 = n0;
      f1 = n1;
      f2 = n2;
      f3 = n3;
   ...
   public Func_DayOfMonth(SQLArgument n0) {
      f0 = new NodeToken("DAYOFMONTH");
      f1 = new NodeToken("(");
      f2 = n0;
      f3 = new NodeToken(")");
   }
