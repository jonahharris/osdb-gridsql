 ...
 */
public class Func_Concat implements Node {
   public NodeToken f0;
   public NodeToken f1;
   ...
   public Func_Concat(NodeToken n0, NodeToken n1, SQLArgument n2, NodeToken n3, SQLArgument n4, NodeToken n5) {
      f0 = n0;
      f1 = n1;
      f2 = n2;
      f3 = n3;
   ...
   public Func_Concat(SQLArgument n0, SQLArgument n1) {
      f0 = new NodeToken("CONCAT");
      f1 = new NodeToken("(");
      f2 = n0;
      f3 = new NodeToken(",");
      f4 = n1;
