...
public class SqlAnalyzeDatabase extends ObjectDepthFirst implements IXDBSql,
        IPreparable {
     ...
     */
    @Override
    public Object visit(VacuumDatabase n, Object obj) {
        doVacuum = true;
        if (n.f1.present()) {
     ...
     */
    @Override
    public Object visit(AnalyzeDatabase n, Object obj) {
        doAnalyze = true;
     ...
     */
    @Override
    public Object visit(TableName n, Object obj) {
