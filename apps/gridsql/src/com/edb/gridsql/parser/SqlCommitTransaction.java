 ...
 * query executed
 */
public class SqlCommitTransaction extends ObjectDepthFirst implements IXDBSql,
        IExecutable {

    private XDBSessionContext client;

    public SqlCommitTransaction(XDBSessionContext client) {
        this.client = client;
    }
    ...
    public ExecutionResult execute(Engine engine) throws Exception {
        ...
        return ExecutionResult
                .createSuccessResult(ExecutionResult.COMMAND_COMMIT_TRAN);
    }
