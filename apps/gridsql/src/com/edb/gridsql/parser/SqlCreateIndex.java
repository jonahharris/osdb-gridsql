...
// -----------------------------------------------------------------
public class SqlCreateIndex extends ObjectDepthFirst implements IXDBSql,
        IPreparable {
    ...
    public Object visit(columnListIndexSpec n, Object argu) {
        ...
        if (n.f0.which == 0) {
            ...
            ((Node) ((NodeSequence) n.f0.choice).nodes.get(1)).accept(handler,
                    null);
        ...
        for (Object node : n.f2.nodes) {
            ...
            if (nc.which == 0) {
                ...
                SQLExpressionHandler handler = new SQLExpressionHandler(
                        commandToExecute);
                ((Node) ((NodeSequence) nc.choice).nodes.get(1)).accept(
                        handler, null);
                indexKeyDefinitions.add(new SqlCreateIndexKey(handler.aroot,
                        keyDirection, colOperateor));
            }
    ...
    public void prepare() throws Exception {
        ...
        try {
            ...
            if (columns.size() != 1
                    || table.getSerialColumn() != columns.get(0)) {
